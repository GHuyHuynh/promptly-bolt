              ...
              <>
                ...
                <div className="hidden lg:flex items-center space-x-3 px-3 py-1 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-sm font-medium">{displayUser.totalScore}</span>
                  </div>
                  <div className="w-px h-4 bg-gray-300" />
                  <div className="flex items-center space-x-1">
                    <Trophy className="w-4 h-4 text-orange-500" />
                    <span className="text-sm font-medium">{displayUser.currentStreak}</span>
                  </div>
                </div>
                  ...
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <Avatar className="h-10 w-10">
                        <AvatarImage src={currentUser.photoURL || undefined} alt={displayUser.name} />
                      ...
                      <div className="flex flex-col space-y-2">
                        ...
                        <div className="flex items-center space-x-4 pt-2">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="text-xs font-medium">{displayUser.totalScore} XP</span>
                          </div>
                        </div>
                      </div>
                    </DropdownMenuLabel>
                ...
                <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg mb-3">
                    <div className="flex items-center space-x-3">
                      <div className="flex items-center space-x-1">
                        <Zap className="w-4 h-4 text-yellow-500" />
                        <span className="text-sm font-medium">{displayUser.totalScore} XP</span>
                      </div>
                      <div className="flex items-center space-x-1">
                        <Trophy className="w-4 h-4 text-orange-500" />
                        <span className="text-sm font-medium">{displayUser.currentStreak} streak</span>
                      </div>
                    </div>
                    <Badge variant="outline">Level {displayUser.level}</Badge>
                  </div>
