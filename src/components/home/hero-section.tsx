      ...
      >
        ...
        >
          {aiToolLogos.map((tool, index) => (
            <motion.div
              key={tool.name}
              className={`px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 ${tool.color} font-medium text-sm`}
        ...
        >
          <Badge
            variant="outline"
            className="px-4 py-2 bg-white/10 border-white/20 text-white/90 hover:bg-white/20 transition-all duration-300"
          >
